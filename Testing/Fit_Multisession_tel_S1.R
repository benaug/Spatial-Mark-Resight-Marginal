...
dir.create("Multisession_tel_S1_fits")
n.datasets <- 100
n.cores <- 18
...
out <- foreach(d=1:n.datasets) %dopar% {
  system2("C:\\Users\\ba378\\AppData\\Local\\Programs\\R\\R-4.4.0\\bin\\Rscript.exe", 
          c("D:\\Sync\\Cornell\\Github\\Spatial-Mark-Resight-Marginal\\Testing\\Fit_Multisession_tel_S1_single.R",d=d,seeds[d]), invisible=TRUE)
}
stopCluster(cl.tmp)
