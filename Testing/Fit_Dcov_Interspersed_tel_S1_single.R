...
setwd("D:/Sync/Cornell/Github/Spatial-Mark-Resight-Marginal/Testing/Dcov_Interspersed_tel_S1_fits")
...
if(!filename%in%files.done){#skip if already run
  ...
  setwd("D:/Sync/Cornell/Github/Spatial-Mark-Resight-Marginal/Testing/Dcov_Interspersed_tel_S1_datasets")
