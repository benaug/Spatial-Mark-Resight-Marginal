    ...
    if(z==0){ #propose from prior
      ...
      if(inbox){
        ...
        if(i<=n.marked){ #if marked
          ...
          lp_initial <- lp_initial_s + lp_initial_y.mark + lp_initial_y.mID + lp_initial_y.mnoID + lp_initial_y.unk
          lp_proposed <- lp_proposed_s + lp_proposed_y.mark+ lp_proposed_y.mID + lp_proposed_y.mnoID + lp_proposed_y.unk
        }else{ #else unmarked
