NimModel <- nimbleCode({
  ...
  for(g in 1:N.session){
    ...
    for(i in 1:n.marked[g]){
      y.mID[g,i,1:J.sight[g]] ~ dPoissonVector(lam[g,i,1:J.sight[g]]*K1D.sight[g,1:J.sight[g]]*theta.marked[g,1],z=z[g,i]) #marked and identified detections
    }
    #Unidentified detections by type
    #2b marked with no ID detections
    bigLam.marked[g,1:J.sight[g]] <- GetbigLam(lam=lam[g,1:n.marked[g],1:J.sight[g]],z=z[g,1:n.marked[g]])
    lam.mnoID[g,1:J.sight[g]] <- bigLam.marked[g,1:J.sight[g]]*K1D.sight[g,1:J.sight[g]]*theta.marked[g,2]
    y.mnoID[g,1:J.sight[g]] ~ dPoissonVector(lam.mnoID[g,1:J.sight[g]],z=1) #plug in z=1 to reuse dPoissonVector
    ...
    y.um[g,1:J.sight[g]] ~ dPoissonVector(lam.um[g,1:J.sight[g]],z=1) #plug in z=1 to reuse dPoissonVector
    ...
    y.unk[g,1:J.sight[g]] ~ dPoissonVector(lam.unk[g,1:J.sight[g]],z=1) #plug in z=1 to reuse dPoissonVector
