...
source("NimbleModel SMR Poisson Dcov DA2 Marginal Generalized.R")
source("NimbleFunctions SMR Poisson Dcov DA2 Marginal Generalized.R")
source("init.SMR.Dcov.Generalized.R")
source("sSampler Poisson Dcov Marginal Generalized.R")
source("mask.check.R")
...
inits <- list(p0=0.5,lam0=1,sigma=1)

#This function structures the simulated data to fit the model in Nimble (some more restructing below)
#Also checks some inits
nimbuild <- init.SMR.Dcov.Generalized(data,inits,M=M)
